...
⚠️ PFF/API snapshot partial for Washington, Ohio State; some situational/trenches fields may be unavailable.
...
- **Scoring**: Washington OFF #4 vs Ohio State DEF #1 — Strength vs Strength
- **Pass Protection vs Pass Rush**: Washington OFF #16 vs Ohio State DEF #3 — Weakness vs Strength
- **Pass Protection vs Pass Rush**: Ohio State OFF #3 vs Washington DEF #12 — Strength vs Weakness
- **TFL Avoidance vs TFL Creation**: Washington OFF #16 vs Ohio State DEF #4 — Weakness vs Strength
...
- Top 10s:
  • Red Zone TD%: 75.93% (#2)
  • Rushing Defense: 100.08 (#3)
  • Scoring Offense: 34.1 PPG (#4)
  • Scoring Margin: +15.4 (#4)
  • 3rd Down %: 50.65% (#4)
- Bottom 3:
  • Penalties: 55.3 (#16)
  • Sacks Allowed: 2.62 (#16)
  • TFL Allowed: 71 (#16)

*Ohio State*
- Top 10s:
  • Scoring Defense: 9.3 PPG (#1)
  • Total Defense: 219.1 (#1)
  • Passing Defense: 129.7 (#1)
  • 4th Down %: 70.59% (#1)
  • Time of Possession: 33:07.00 (#1)
- Bottom 3:
  • Rushing Offense: 154.36 (#9)
  • Red Zone TD%: 66.67% (#9)
  • Penalties: 38.9 (#8)
...
- Delta using PBP 20+ vs CFBStats: -4 (-5.5%) (residual -4)
- Without Explosives: Run 3.85 / Pass 7.70
- Top Plays:
  • **78 yd pass — Williams Jr.,Demond**
    [SG] WILLIAMS JR., Demond pass deep up the middle complete for 78 yards to BOSTON, Denzel caught at the BSU34 and advanced to the BSU0, 1ST DOWN, TOUCHDOWN WAS, clock 09:54 (Scoring play confirmed).
  • **68 yd run — Washington,Jordan**
    Washington,Jordan rush right for 68 yards gain to the PUR00 TOUCHDOWN, clock 07:05, 1ST DOWN.
  • **61 yd pass — Williams Jr.,Demond → Harris,Audric**
...
*Ohio State*
- CFBStats Explosives (20+): 57 (#4)
- PBP Explosives: 71 (Pass 45, Rush 26)
- Delta (PBP-CFBStats): +14 (+24.6%) · High mismatch
- 15-19y Rushes (PBP only): 14 (expected definition delta)
- PBP 20+ (pass/rush): 57 (Pass 45, Rush 12)
- Delta using PBP 20+ vs CFBStats: 0 (0.0%) (residual 0)
- Without Explosives: Run 3.85 / Pass 8.01
- Top Plays:
  • **87 yd pass — Sayin,Julian → Smith,Jeremiah**
    Shotgun Sayin,Julian pass complete deep left to Smith,Jeremiah caught at OSU45, for 87 yards to the GSU00 TOUCHDOWN, clock 08:54, 1ST DOWN.
  • **64 yd run — Jackson,Bo**
    Shotgun Jackson,Bo rush middle for 64 yards gain to the OU11 (Mack II,Michael), out of bounds, 1ST DOWN.
  • **59 yd pass — Sayin,Julian → Smith,Jeremiah**
    [SG] SAYIN, Julian pass deep up the middle complete for 59 yards to SMITH, Jeremiah caught at the MIA25 and advanced to the MIA16 (O'CONNOR, Ethan), 1ST DOWN, clock 13:16.
...
*Washington*
- FG%: 76.9% (Long 51)
- Punt Avg: 40.3 (Net 34.6)
- 2PT O/D: 0/0 · 1/2
- Return TDs: 1

*Ohio State*
- FG%: 80.0% (Long 53)
- Punt Avg: 42.5 (Net 40.8)
- 2PT O/D: 0/0 · 0/2
- Return TDs: 0

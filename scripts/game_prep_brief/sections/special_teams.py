...
def _team_html(team: dict) -> str:
    ...
    <div class="team-card">
      ...
      <div class="block">
        ...
        <ul>
          <li>Offense: {stats['two_pt_conv']} / {stats['two_pt_att']}</li>
          <li>Defense Allowed: {stats['two_pt_allowed_conv']} / {stats['two_pt_allowed_att']}</li>
          <li>Last 3 O/D: {stats['l3_two_pt_conv']}/{stats['l3_two_pt_att']} · {stats['l3_two_pt_allowed_conv']}/{stats['l3_two_pt_allowed_att']}</li>
        </ul>
      </div>
    </div>
    """
...
def _team_md(team: dict) -> str:
    ...
    return "\n".join([
        ...
        f"- 2PT O/D: {stats['two_pt_conv']}/{stats['two_pt_att']} · {stats['two_pt_allowed_conv']}/{stats['two_pt_allowed_att']}",
